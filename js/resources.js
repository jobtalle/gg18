...
Resources.prototype = {
    load() {
        ...
        this.biemer_base = new Sprite("img/biemer/biemer_base.png", 2.5,9,2);
        this.biemer_empty = new Sprite("img/biemer/biemer_empty.png", 7.5,6,2);
        ...
        this.biemer_spark = new Sprite("img/biemer/biemer_spark.png", 6.5, 9,11,20);
        ...
        this.entrance = new AudioSource("sfx/entrance.ogg", true);
        ...
        this.sand = new AudioSource("sfx/sand.ogg", true);
